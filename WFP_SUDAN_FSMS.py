...
FSMS_Dec_2024 = pd.read_csv('data/FSMS_Dec_2024_4.csv')
df = FSMS_Dec_2024
...
df['fcs'] = df["Q5_1a"] * 2 + df["Q5_2a"] * 3 + df["Q5_3a"] * 4 + df["Q5_4a"] * 4 + df["Q5_5a"] * 1 + df["Q5_6a"] * 1 + \
...
with tab3:
    ...
    children_24months_17_years_columns = ['Q2_4_2a', 'Q2_4_2b', 'Q2_4_3a', 'Q2_4_3b', 'Q2_4_4a', 'Q2_4_4b']
